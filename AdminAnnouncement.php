...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="Adminhome.php" id="ad"><img src="logo2.png"><span class="text">IETI</span> E-Library</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="AdminAnnouncement.php">Announcement</a>
        </li>
...
<center><a href="addAnnouncement.php" class="btn btn-primary float-end"> Add Announcement</a></center>
...
<div class="card">
  ...
  <form action="create.php" method="POST" class="d-inline">
                  <button type ="submit" name="delete_ann" value="<?=$Ann['ID'];?>" class="btn btn-danger btn-sm">Delete</a>
                </form>
  </div>
</div>
