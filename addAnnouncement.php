    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card-header">
                <h3 >
                Add Announcements
                <a href="AdminAnnouncement.php" class="btn btn-danger float-end">Back</a>
                </h3>
                </div> 
                <div class="card-body">
                    <form action="create.php" method ="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <center><button type="submit" name="add_announcement" class="btn btn-primary">Save</button></center>
                        </div>
                    </form>