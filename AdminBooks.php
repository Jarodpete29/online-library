...
<div class="container5 container mt-5">
    ...
    <nav class="navbar ">
            ...
            <a href="addbooks.php" id="cc" class="btn btn-primary float-end">ADD</a>
            <a href="archive.php" id="bb" class="btn btn-danger ">Archive</a>
    </form>      
</div>
                ...
                <div class="row">
                    <div class="col-md-12">
                      ...
                      <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                          <?php
                          $query = "SELECT * FROM books WHERE archive=1";
                          if(isset($_GET['query'])){
                          ...
                          if(mysqli_num_rows($query_run)>0){
                            foreach($query_run as $books)
                            {
                              ...
                              <tr>
                                ...
                                <td class="btn-cont">
                                  <a href="editbooks.php?ID=<?= $books['ID']; ?>" class="btn1 btn-success btn-sm">Edit</a>
                                
                                  <form action="create.php" method="POST" class="d-inline">
                                    <button type ="submit" name="delete" value="<?=$books['ID'];?>" class="btn1 btn-danger btn-sm">Delete</a>
                                  </form>
                                
                                  <form action="create.php" method="POST" class="d-inline" >
                                    <button type ="submit"  name="read" value="<?=$books['ID'];?>" class="btn1 btn-primary  btn-block">Read</a>
                                  </form>
